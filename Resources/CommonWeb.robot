...
Open test app
    ...
    Open Application  ${REMOTE_URL}  platformName=${platformName}  deviceName=${deviceName}  visual=${visual}  console=${console}  network=${network}  devicelog=${devicelog}  isRealMobile=${isRealMobile}  name=LT_iOS_Robot_Web  build=LT_Appium_Robot_Web_Automation
